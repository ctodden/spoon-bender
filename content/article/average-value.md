...
{{< cfig src="avg_height.png" width="80%" caption="Average value of $f$ as average graph height" >}}
...
{{< cfig src="avg_val_approximation.png" width="80%" caption="Approximating the average value via a Riemann sum" >}}
